...
fun main() {
    ...
    ComposeLWJGL.enableGlobalSnapshotManager = false

//    Required for LWJGL if [ComposeLWJGL.enableGlobalSnapshotManager] is set to true.
//    ComposeLWJGL.globalSnapshotManagerDispatcher = newSingleThreadContext("LWJGL Dispatcher")
